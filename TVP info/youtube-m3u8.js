  ...
  case "master.mpd":
   try {
    return Response.redirect(
     await dashUrl( 
       "https://www.youtube.com/c/TVPInfo" + pathName[2] + "/live"
    ),
    302
  );
} catch (err) {
  return Response.redirect(
    await dashUrl("https://www.youtube.com/watch?v=3jKb-uThfrg" + pathName[2]),
    302
  );
 }
case "master.m3u8":
try {
  ...
  return Response.redirect(
    await hlsUrl("https://www.youtube.com/watch?v=3jKb-uThfrg" + pathName[2]),
    302
   );
  }
default:
